...
var addToCart = document.querySelectorAll('.add-to-cart'); //console.log(cartCounter)
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.status = data.status; //console.log(updatedOrder)
